...
public:
    ...
    int delKeyRange(float startKey, float endKey)
    {
        ...
        std::vector<float> vec = findKeyRangeReturnFloat(startKey, endKey);
        std::cout << vec.size() << "   ";
  ...
  std::vector<float> findKeyRangeReturnFloat(float startKey, float endKey){
